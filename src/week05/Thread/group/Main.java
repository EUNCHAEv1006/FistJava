...
public class Main {
    public static void main(String[] args) {
        ...
        // week05.Thread 객체 생성시 첫번째 매개변수로 넣어줍니다.
        // week05.Thread(ThreadGroup group, Runnable target, String name)
        Thread thread1 = new Thread(group1, task, "week05.Thread 1");
        Thread thread2 = new Thread(group1, task, "week05.Thread 2");
