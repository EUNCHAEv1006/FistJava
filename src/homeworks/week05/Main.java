...
public class Main {
    public static void main(String[] args) {
        ...
        bookList.stream()
                ...
                .forEach(f -> System.out.println("제목에 '경제'가 들어간 책 제목: " + f.getBookName()));
        System.out.println("------------------------------------------------------------");
        ...
        System.out.println("가격이 가장 비싼 책의 가격: " + maxPrice);
        System.out.println("------------------------------------------------------------");
        ...
        // (6) 책 할인 이벤트(IT 책 할인 이벤트!!)
        // 카테고리가 IT인 책들의 가격을 40% 할인하여 새로운 책 리스트 만들기, discountBookList
        ...
        for(Book book: discountBookList){
